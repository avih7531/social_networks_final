...
\author{Avi Herman}
\date{Social Networks Analysis --- Fall 2025}
...
\begin{frame}{Result 3: Genre Separation}
  \begin{columns}
    \column{0.5\textwidth}
    \includegraphics[width=\textwidth]{250/confusion_matrix_macro.png}
...
\begin{frame}{Result 6: Genre Co-Occurrence Chord Diagram}
  \begin{columns}
    \column{0.6\textwidth}
    \includegraphics[width=\textwidth]{5000/genre_cooccurrence_chord.png}
